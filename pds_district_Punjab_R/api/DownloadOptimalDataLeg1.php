...
if (isset($_GET['format'])) {
	...
	$columns = ["scenario","from","from_state","from_id","from_name","from_district","from_centre","from_lat","from_long","to","to_state","wb_id","wb_lat","wb_long","to_id","to_name","to_district","to_centre","to_lat","to_long","commodity","quantity","distance"];
