    ...
    while (($column = fgetcsv($file, 10000, ",")) !== FALSE) {
        ...
        /* DATA ROW */
            ...
            if (!isStringNumber($column[$Paddy_Procurement])) {
                echo "Error : Wheat Procurement must be a valid non-negative number. Given: ".$column[$Paddy_Procurement]."<br>";
                $redirect = 0;
            }
            ...
            if (!in_array($column[$Storage_Point], $storagePoints)) {
                echo "Error : Invalid Storage Point - ".$column[$Storage_Point]."<br>";
                $redirect = 0;
            }
