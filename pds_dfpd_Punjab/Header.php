    ...
    <body>
        ...
        <div class="page-sidebar">
			...
			<ul class="x-navigation">
				...
				<li <?php echo ($current_page === 'OptimisedDataAll_R.php') ? 'class="active"' : ''; ?>>
					<a href="OptimisedDataAll_R.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">PC to MILL Details</span></a>
				</li>
				
				<li <?php echo ($current_page === 'OptimisedDataAll_W.php') ? 'class="active"' : ''; ?>>
					<a href="OptimisedDataAll_W.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">PC to WAREHOUSE Details</span></a>
				</li>
