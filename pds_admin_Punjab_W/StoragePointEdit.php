...
$uid = $_POST['uid'];
$query = "SELECT * FROM storage_point WHERE id='$uid'";
...
<script>
	function verifyCaptcha() {
		...
		document.getElementById("password").value = encrypted;
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>                    
                    <li class="active">Storage Point Edit</li>
                </ul>
                <!-- END BREADCRUMB -->                       
                 ...
                 <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="api/StoragePointEdit.php" method="POST" class="form-horizontal">
                            <div class="panel panel-default">
                               <div class="panel-body">
                                    <p>Fill this form to Edit Storage Point Name.</p>
                                </div>
