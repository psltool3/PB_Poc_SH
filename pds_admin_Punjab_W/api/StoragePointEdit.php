...
if(password_verify($person->getPassword(), $dbHashedPassword)){
	...
	$StoragePoint->setName(formatName(str_replace("'","",$_POST['name'])));
	$StoragePoint->setId(str_replace("'","",$_POST['uid']));
	...
	if($result){
		...
		writeLog("User ->" ." Storage Point Name Edit->". $_SESSION['user'] . "| Requested JSON -> " . json_encode($filteredPost));
