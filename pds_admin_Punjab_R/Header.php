        ...
        <div class="page-sidebar">
			...
			<ul class="x-navigation">
				...
				<li <?php echo ($current_page === 'Performa.php') ? 'class="active"' : ''; ?>>
					<a href="Performa.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">Proforma Leg</span></a>
				</li>
				...
				<li>
					<a href="/Proc_Tool/Proc_Manual/PB_Kms_Manual.pdf" download style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">Manual</span></a>
				</li>
				<li>
