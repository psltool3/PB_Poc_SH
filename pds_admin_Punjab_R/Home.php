		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading" style="text-align: center;">
					...
					<h1 style="font-weight: bold; color: #FF6666;">Kindly Optimise the Leg1-PC to Mill</h1>
					...
					<div class="form-group">
						...
						<div class="col-md-9">  
							...
							<select class="form-control" id="type" name="type" style="border-radius:5px;font-weight:bold">
								...
								<option value='inter' selected style="font-weight:bold;color:#000;">Intra District</option>
							</select>
							</div>
