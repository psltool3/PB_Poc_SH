							...
							<div class="row">
								...
								<div class="col-md-3 mb-4">
									<div class="card h-100"
										...
										<div style="font-size:15px">TOTAL TAGS IMPLEMENTED</div>
									</div>
								</div>
								<div class="col-md-3 mb-4">
									<div class="card h-100"
					...
					success: function(result){
						...
						try{
							...
							for (var datafield in obj) 
							{
								...
								var newname_district = obj[datafield]["new_name_district"] ? obj[datafield]["new_name_district"] : "";
								var reason_admin = obj[datafield]["reason_admin"] ? obj[datafield]["reason_admin"] : "";
								...
								var distance_district = obj[datafield]["new_distance_district"] ? obj[datafield]["new_distance_district"] : "";
